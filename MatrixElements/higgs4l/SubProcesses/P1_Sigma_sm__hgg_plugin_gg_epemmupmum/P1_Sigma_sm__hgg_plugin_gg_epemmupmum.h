...
class P1_Sigma_sm__hgg_plugin_gg_epemmupmum: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm__hgg_plugin_gg_epemmupmum(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm__hgg_plugin_gg_epemmupmum() {}; 
  ...
  private:
    ...
    P1_Sigma_sm__hgg_plugin_gg_epemmupmum() = delete; 
    ...
    // Matrix elements
    double matrix_1_gg_h_epemmupmum_no_a(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm__hgg_plugin_gg_epemmupmum >> > mapFinalStates;

    // Reference to the model parameters instance passed in the constructor
    std::shared_ptr < Parameters_sm__hgg_plugin > params; 
